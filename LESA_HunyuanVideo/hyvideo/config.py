...
def parse_args_predictor():
    parser = argparse.ArgumentParser(description="Predictor Args")
    
    parser.add_argument('--prompt_file', type=str, default='train_prompts_video.txt', help='Path to the prompt text file.')
...
def add_inference_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--seed", type=int, default=42, help="Seed for evaluation.")
    ...
    group.add_argument(
        "--vbench-json-path",
        type=str,
        default="eval/VBench_full_info.json",
